...
PIE:      No PIE (0x400000)
```
Since NX is enabled, we will do a ret2function attack to jump to _print\_flag_ function. Then we will perform some format string. I will skip the details for ret2function. If you want, you can read [this](/blog/ret2win) blog.
